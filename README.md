...
iwr -useb "https://raw.githubusercontent.com/Thanh-262009/rust-proxy/main/scripts/install-windows.ps1" | iex
```

### **Linux/macOS:**
```bash
# Download and run setup
curl -fsSL "https://raw.githubusercontent.com/Thanh-262009/rust-proxy/main/scripts/install-linux.sh" | bash
```
...
license = "MIT"
repository = "https://github.com/Thanh-262009/rust-proxy"
...
Documentation=https://github.com/Thanh-262009/rust-proxy
...
```powershell
iwr -useb "raw.githubusercontent.com/Thanh-262009/rust-proxy/main/install.ps1" | iex
```

### **Linux/macOS:**
```bash
curl -fsSL "raw.githubusercontent.com/Thanh-262009/rust-proxy/main/install.sh" | bash
```
...
```bash
# Clone and build
git clone https://github.com/Thanh-262009/rust-proxy.git
cd rust-proxy
